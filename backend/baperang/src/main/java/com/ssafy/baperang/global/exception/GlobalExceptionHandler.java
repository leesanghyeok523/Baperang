...
public class GlobalExceptionHandler {
    ...
    // 커스텀 예외 처리
    @ExceptionHandler(PictoryCustomException.class)
    public ResponseEntity<ErrorResponse> handlePictoryCustomException(PictoryCustomException ex) {
        PictoryErrorCode errorCode = ex.getErrorCode();
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(Exception ex) {
        PictoryErrorCode errorCode = PictoryErrorCode.INVALID_LOGIN_VALUE;
        ErrorResponse response = ErrorResponse.of(errorCode);
    ...
    public ResponseEntity<ErrorResponse> handleIllegalException(Exception ex) {
        PictoryErrorCode errorCode = PictoryErrorCode.INVALID_INPUT_VALUE;
        ErrorResponse response = ErrorResponse.of(errorCode);
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(Exception ex) {
        ErrorResponse response = ErrorResponse.of(PictoryErrorCode.INVALID_INPUT_VALUE);
    ...
    public ResponseEntity<ErrorResponse> handleAuthorizationException(Exception ex) {
        ErrorResponse response = ErrorResponse.of(PictoryErrorCode.INVALID_ACCESS);
    ...
    public ResponseEntity<String> handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex) {
        ErrorResponse errorResponse = ErrorResponse.of(PictoryErrorCode.QUEUE_TIMEOUT);
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception ex) {
        ErrorResponse response = ErrorResponse.of(PictoryErrorCode.INTERNAL_SERVER_ERROR);
